...
public class MainActivity extends VrActivity implements MediaPlayer.OnVideoSizeChangedListener,
		AudioManager.OnAudioFocusChangeListener		
{
	...
	public void onVideoSizeChanged( MediaPlayer mp, int width, int height ) 
	{
		...
		nativeSetVideoSize( getAppPtr(), width, height, rotation, duration );
	}
