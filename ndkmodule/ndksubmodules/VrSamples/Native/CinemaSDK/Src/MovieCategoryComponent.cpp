...
eMsgStatus MovieCategoryComponent::OnEvent_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame,
...
eMsgStatus MovieCategoryComponent::Frame( OvrGuiSys & guiSys, VrFrame const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
	UpdateColor( self );
...
eMsgStatus MovieCategoryComponent::FocusGained( OvrGuiSys & guiSys, VrFrame const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
	//LOG( "FocusGained" );
	HasFocus = true;
...
eMsgStatus MovieCategoryComponent::FocusLost( OvrGuiSys & guiSys, VrFrame const & vrFrame,
        VRMenuObject * self, VRMenuEvent const & event )
{
	//LOG( "FocusLost" );
