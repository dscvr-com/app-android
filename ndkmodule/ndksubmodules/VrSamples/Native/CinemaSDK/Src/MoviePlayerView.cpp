...
Matrix4f MoviePlayerView::GetEyeViewMatrix( const int eye ) const
{
	return Cinema.SceneMgr.GetEyeViewMatrix( eye );
}

Matrix4f MoviePlayerView::GetEyeProjectionMatrix( const int eye, const float fovDegreesX, const float fovDegreesY ) const 
{
 ...
 * DrawEyeView
 */
Matrix4f MoviePlayerView::DrawEyeView( const int eye, const float fovDegreesX, const float fovDegreesY, ovrFrameParms & frameParms )
{
