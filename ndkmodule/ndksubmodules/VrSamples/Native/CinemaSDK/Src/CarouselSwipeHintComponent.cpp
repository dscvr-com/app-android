...
eMsgStatus CarouselSwipeHintComponent::OnEvent_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame,
...
eMsgStatus CarouselSwipeHintComponent::Opening( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self, VRMenuEvent const & event )
{
	Reset( self );
	return MSG_STATUS_ALIVE;
}
...
eMsgStatus CarouselSwipeHintComponent::Frame( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self, VRMenuEvent const & event )
{
