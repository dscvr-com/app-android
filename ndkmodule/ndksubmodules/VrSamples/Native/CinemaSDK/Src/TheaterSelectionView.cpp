...
Matrix4f TheaterSelectionView::GetEyeViewMatrix( const int eye ) const
{
	return Cinema.SceneMgr.GetEyeViewMatrix( eye );
}

Matrix4f TheaterSelectionView::GetEyeProjectionMatrix( const int eye, const float fovDegreesX, const float fovDegreesY ) const 
{
	return Cinema.SceneMgr.GetEyeProjectionMatrix( eye, fovDegreesX, fovDegreesY );
}

Matrix4f TheaterSelectionView::DrawEyeView( const int eye, const float fovDegreesX, const float fovDegreesY, ovrFrameParms & frameParms )
{
