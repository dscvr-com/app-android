...
#define OVR_CAPTURE_CONFIG_H
  ...
  //#define OVR_CAPTURE_WRAP_LOGCAT
...
#define OVR_CAPTURE_UNUSED(x) ((void)x)
...
// Compile Time Assert support...
	...
	#define OVR_CAPTURE_STATIC_ASSERT(exp) static_assert(exp, #exp)
#endif
#if !defined(OVR_CAPTURE_STATIC_ASSERT) && defined(__clang__)
