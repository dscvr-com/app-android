...
public:
	...
	// If length is != 0, an event is pending. Applications should remove events
	// from this queue as they handle them if they do not want the default event
	// behavior to happen in the framework.
