...
static ovrOSKeyInfo_t const OvrKeyToAndroidKeyMap[OVR_KEY_MAX] =
{
	...
	{ 0,							OVR_INPUT_DEVICE_MAX },	// marker 1
	...
	{ 0,							OVR_INPUT_DEVICE_MAX },	// marker 2
	...
	{ 0,							OVR_INPUT_DEVICE_MAX },	// marker 3
	...
	{ 0,							OVR_INPUT_DEVICE_ANY },	// OVR_KEY_PAUSE - no equivalent
	{ 0,							OVR_INPUT_DEVICE_ANY },	// OVR_KEY_PRINT_SCREEN - no equivalent
	...
	{ 0,							OVR_INPUT_DEVICE_MAX }, // marker 4
	...
	{ 0,							OVR_INPUT_DEVICE_MAX },	// marker 5
	...
	{ AKEYCODE_SLASH,				OVR_INPUT_DEVICE_ANY },	// ? = slash + shift
	{ AKEYCODE_SEMICOLON,			OVR_INPUT_DEVICE_ANY },	// ;
	{ AKEYCODE_SEMICOLON,			OVR_INPUT_DEVICE_ANY },	// : = semicolon + shift
	{ AKEYCODE_APOSTROPHE,			OVR_INPUT_DEVICE_ANY },	// '
	{ AKEYCODE_APOSTROPHE,			OVR_INPUT_DEVICE_ANY },	// " = ' + shift
	{ AKEYCODE_LEFT_BRACKET,		OVR_INPUT_DEVICE_ANY },	// [
	{ AKEYCODE_RIGHT_BRACKET,		OVR_INPUT_DEVICE_ANY },	// ]
	{ AKEYCODE_LEFT_BRACKET,		OVR_INPUT_DEVICE_ANY },	// { = shift + [
	{ AKEYCODE_RIGHT_BRACKET,		OVR_INPUT_DEVICE_ANY },	// } = shift + ]
	{ AKEYCODE_BACKSLASH,			OVR_INPUT_DEVICE_ANY },	/* | = shift + \ */
	{ AKEYCODE_GRAVE,				OVR_INPUT_DEVICE_ANY },	// ~ = shift + `
	{ AKEYCODE_GRAVE,				OVR_INPUT_DEVICE_ANY },	// '
	{ 0,							OVR_INPUT_DEVICE_ANY },	// marker 6
	...
	{ 0,							OVR_INPUT_DEVICE_ANY },	// marker 8
	...
	{ 0,							OVR_INPUT_DEVICE_ANY },	// marker 9
	...
	{ 0,							OVR_INPUT_DEVICE_JOYPAD }	// marker 10
};
#else
...
static ovrOSKeyInfo_t const OvrKeyToVirtualKeyMap[OVR_KEY_MAX] =
{
	...
	{ 0,							OVR_INPUT_DEVICE_ANY },	// marker 3
	...
	{ 0,							OVR_INPUT_DEVICE_ANY }, // marker 4
	...
	{ 0,							OVR_INPUT_DEVICE_ANY },	// marker 5
	...
	{ 0,							OVR_INPUT_DEVICE_ANY }	// marker 10
};
		...
		ovrKeyInfo_t * & osKeyMap, int & mapSize )
{
	...
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_1].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_2].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_3].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_4].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_5].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_6].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_7].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_8].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_9].OScode == 0 );
	OVR_ASSERT( ovrKeyMap[OVR_KEY_MARKER_10].OScode == 0 );
