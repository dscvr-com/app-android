...
// FIXME:VRAPI remove
#include "VrApi_Types.h"	// for vrapi_GetTimeInSeconds()
...
eMsgStatus OvrAnimComponent::Frame( OvrGuiSys & guiSys, VrFrame const & vrFrame,
...
eMsgStatus OvrAnimComponent::OnEvent_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame, 
		VRMenuObject * self, VRMenuEvent const & event )
{
...
void OvrSurfaceAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self ) const
{
...
void OvrTrailsAnimComponent::SetFrameVisibilities( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self ) const
{
