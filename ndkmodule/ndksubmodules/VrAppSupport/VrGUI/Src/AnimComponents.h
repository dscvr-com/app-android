...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self ) const = 0;
...
protected:
	virtual void	SetFrameVisibilities( OvrGuiSys & guiSys, VrFrame const & vrFrame, VRMenuObject * self ) const;
