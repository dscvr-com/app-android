...
eMsgStatus OvrTextFade_Component::OnEvent_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame,
...
eMsgStatus OvrTextFade_Component::Frame( OvrGuiSys & guiSys, VrFrame const & vrFrame,
											VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrTextFade_Component::FocusGained( OvrGuiSys & guiSys, VrFrame const & vrFrame,
												VRMenuObject * self, VRMenuEvent const & event )
{
...
eMsgStatus OvrTextFade_Component::FocusLost( OvrGuiSys & guiSys, VrFrame const & vrFrame,
												VRMenuObject * self, VRMenuEvent const & event )
{
