...
eMsgStatus OvrProgressBarComponent::OnEvent_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame,
...
eMsgStatus OvrProgressBarComponent::OnFrameUpdate( OvrGuiSys & guiSys, VrFrame const & vrFrame,
		VRMenuObject * self, VRMenuEvent const & event )
{
