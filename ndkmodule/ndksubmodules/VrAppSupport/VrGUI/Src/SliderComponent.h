...
private:
	...
	eMsgStatus			OnInit( OvrGuiSys & guiSys, VrFrame const & vrFrame, 
								VRMenuObject * self, VRMenuEvent const & event );

	eMsgStatus			OnFrameUpdate( OvrGuiSys & guiSys, VrFrame const & vrFrame, 
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchDown( OvrGuiSys & guiSys, VrFrame const & vrFrame, 
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchUp( OvrGuiSys & guiSys, VrFrame const & vrFrame, 
								VRMenuObject * self, VRMenuEvent const & event );
	eMsgStatus			OnTouchRelative( OvrGuiSys & guiSys, VrFrame const & vrFrame,
								VRMenuObject * self, VRMenuEvent const & event );
