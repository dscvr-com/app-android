...
public:
	...
	void					Frame( OvrGuiSys & guiSys, VrFrame const & vrFrame, Matrix4f const & viewMatrix );
	...
	void					OnItemEvent( OvrGuiSys & guiSys, VRMenuId_t const itemId, class VRMenuEvent const & event );
...
private:
	...
	virtual void	OnItemEvent_Impl( OvrGuiSys & guiSys, VRMenuId_t const itemId, class VRMenuEvent const & event );
