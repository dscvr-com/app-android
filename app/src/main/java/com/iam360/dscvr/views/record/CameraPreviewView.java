...
import com.iam360.dscvr.util.AutoFitTextureCameraView1;
...
public class CameraPreviewView extends AutoFitTextureCameraView1
...
//    };
    ...
    private SurfaceHolder.Callback mSurfaceTextureListener
     ...
     */
    private AutoFitTextureCameraView1 mTextureView;
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            if(null != dataListener) {
                Timber.d("dataListener cameraOpened");
        ...
        public void onDisconnected(@NonNull CameraDevice cameraDevice) {
            ...
            mCameraDevice = null;
            if(null != dataListener) {
                Timber.d("dataListener cameraClosed");
...
//            }
    ...
    private Size videoSize = new Size(720, 1280); //Size we want for stitcher input
    ...
    private void showToast(final String text) {
        if(context instanceof RecorderActivity) {
            final Activity activity = ((RecorderActivity) context);
            if (activity != null) {
    ...
    public static CameraPreviewView newInstance(Context ctx) {
        return new CameraPreviewView(ctx);
    }
    ...
    public void onResume() {
        ...
        Timber.d("Staring background thread");
...
//                    int tempHeight = largest.getHeight();
//                    int tempWidth = largest.getWidth();
//                    largest = null;
//                    largest = new Size(tempHeight, tempWidth);
                }
...
//                Log.w(TAG, "Message tag: " + msg.what);
    ...
    private void createDecoderSurface() {
        codecSurface = new CodecSurface(videoSize.getHeight(), videoSize.getWidth());
        ...
        try {
            if(dataListener != null) {
                if(codecSurface.awaitNewImage()) {
                    ...
                    dataListener.imageDataReady(codecSurface.fetchPixels(), codecSurface.getWidth(), codecSurface.getmHeight(), codecSurface.colorFormat);
                } else
                    Timber.d("Fetch await image false");
    ...
    private void createCameraPreviewSession() {
        try {
//            SurfaceTexture texture = mTextureView.getHolder().getSurface();
//            assert texture != null;
...
//            Surface surface = new Surface(texture);
            ...
            mPreviewRequestBuilder.addTarget(codecSurface.getSurface());

            // Here, we create a CameraCaptureSession for camera preview.
            mCameraDevice.createCaptureSession(Arrays.asList(surface, codecSurface.getSurface()),
