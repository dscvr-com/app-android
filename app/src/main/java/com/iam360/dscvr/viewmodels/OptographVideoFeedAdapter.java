...
//            int height = (int)(((ITEM_WIDTH / 3) * 2) + (5 * DENSITY));
            ...
            if(DBHelper.nullChecker(optograph.getStory().getId()).equals("")){
                holder.getBinding().storyIcon.setVisibility(View.GONE);
            }else{
                holder.getBinding().storyIcon.setVisibility(View.VISIBLE);
            }
