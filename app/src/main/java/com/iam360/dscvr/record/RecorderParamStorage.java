...
public class RecorderParamStorage {
    public static RecorderParamInfo getRecorderParams(float flen, float sx, float sy, boolean usingMotor) {
        ...
        double hOverlap = usingMotor ? 0.0 : -0.5;
        ...
        switch(android.os.Build.MODEL) {
            ...
            */
             ...
             */
            case "ONEPLUS A5000":
            default: return new RecorderParamInfo(0.9, 0.25, 0.6, hOverlap, 2.0, true);
            case "SM-N920I": return new RecorderParamInfo(0.8, 0.25, 0.55, hOverlap, 2.0, true);
        }
    }
}
