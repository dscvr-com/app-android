...
public abstract class BaseVideoItem implements VideoItem, ListItem{
     ...
     */
    public abstract void update(int position, OptographVideoViewHolder view, VideoPlayerManager videoPlayerManager);
    ...
    public void setActive(View newActiveView, int newActiveViewPosition) {
        OptographVideoViewHolder viewHolder = (OptographVideoViewHolder) newActiveView.getTag();
        playNewVideo(new CurrentItemMetaData(newActiveViewPosition, newActiveView), viewHolder.videoView, mVideoPlayerManager);
    }
    ...
    public View createView(ViewGroup parent, int screenWidth) {
        ...
        final OptographVideoViewHolder videoViewHolder = new OptographVideoViewHolder(view);
        view.setTag(videoViewHolder);

        videoViewHolder.videoView.addMediaPlayerListener(new MediaPlayerWrapper.MainThreadMediaPlayerListener() {
            @Override
            ...
            public void onVideoPreparedMainThread() {
                ...
                videoViewHolder.previewImage.setVisibility(View.INVISIBLE);
            }
    ...
    private void setVisibilityPercentsText(View currentView, int percents) {
        ...
        OptographVideoViewHolder videoViewHolder = (OptographVideoViewHolder) currentView.getTag();
