...
/**
 * Created by Joven on 9/21/2016.
 */
public class MarkerCube {
    ...
    private float cubeHalfSize = 0.7f;


    public MarkerCube(Context context) {
        this.context = context;

        // Allocate vertex buffer. A float has 4 bytes
        ...
        for (int face = 0; face < numFaces; face++) {
            ...
            float faceWidth = 1.4f;
            float faceHeight = 1.4f;
